...
class BidPublisherMaxValAlgoTest {

	@Test
	public void testWinningBidCaseBicycle() {
		BidPublisherMaxValAlgo bidPublisherMaxValAlgo = new BidPublisherMaxValAlgo();
		...
		WinnerBidData winningBidder = bidPublisherMaxValAlgo.getWinningBid(bidderListforBicycle);
	...
	public void testWinningBidCaseScooter() {
		...
		WinnerBidData winningBidder = bidPublisherMaxValAlgo.getWinningBid(bidderListforScooter);
	...
	public void testWinningBidCaseBoat() {
		...
		WinnerBidData winningBidder = bidPublisherMaxValAlgo.getWinningBid(bidderListforBoat);
	...
	public void testWinningBidCaseMobile() {
		...
		WinnerBidData winningBidder = bidPublisherMaxValAlgo.getWinningBid(bidderListforMobile);
		assertEquals(1, winningBidder.getBidderID());
